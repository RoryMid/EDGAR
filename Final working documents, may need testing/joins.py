...
def yahoo_avg():
    tickers = get_sp100()
    df_yahoo_avg=get_yahoo_data('2018-01-01','2021-01-01',tickers)
    ...
    df_yahoo_avg['1daily_return_market'] = (mask.shift(-1) - mask)/mask
    df_yahoo_avg['2daily_return_market'] = (mask.shift(-2) -mask)/mask
    df_yahoo_avg['3daily_return_market'] = (mask.shift(-3) - mask)/mask
    df_yahoo_avg['5daily_return_market'] = (mask.shift(-5) - mask)/mask
    df_yahoo_avg['10daily_return_market'] = (mask.shift(-10) - mask)/mask
    return df_yahoo_avg
...
def merge_wordcounts_and_yahoo(output_folder):
    ...
    df_yahoo = get_yahoo_data('2018-01-01','2021-01-01', tickers)
