...
def selenium_activate(key):
    ...
    w.until(expected_conditions.element_to_be_clickable((By.XPATH, r'/html/body/main/div[5]/div/div[1]/div[1]/div/input[3]')))
    driver.find_element_by_xpath(xpath_search1).click()
    driver.find_element_by_xpath(searchinput_path1).send_keys('2000-01-01', Keys.ENTER)

   # searchinput_path2 = r'/html/body/main/div[5]/div/div[1]/div[1]/div/input[3]'
    #driver.find_element_by_xpath(searchinput_path2).send_keys('20000101', Keys.ENTER)
